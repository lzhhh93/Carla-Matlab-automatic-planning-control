...
class BehaviorAgent(Agent):
    ...
    def __init__(self, vehicle, ignore_traffic_light=True, behavior='normal'):
        ...
        self.min_speed = 5
        self.behavior = None
        self._sampling_resolution = 1.0 #4.5
    ...
    def set_destination(self, start_location, end_location, clean=False, debug=True):
        """
        ...
        self._local_planner.set_global_plan(route_trace, clean, debug)
